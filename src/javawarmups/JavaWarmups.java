...
//        public static int averages(int numberOne, int numberTwo, int numberThree){
//            ArrayList<Integers> averages = new ArrayList<Integers>();
//            numberOne.add();
//            numberTwo.add();
//            numberThree.add();
//            System.out.printf("%d", averages);
//
//        }
...
/**
 *
 * //    public static String returnFirstCapitalLetter(String word){
